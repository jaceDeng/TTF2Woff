		...
		internal int proc(ZStream z, int r)
		{
			...
			while (true)
			{
				...
				case 0:
				{
					...
					int num7 = num3 & 7;
					last = (num7 & 1);
					switch (SupportClass.URShift(num7, 1))
					{
					case 0:
						num3 = SupportClass.URShift(num3, 3);
						i -= 3;
						num7 = (i & 7);
						num3 = SupportClass.URShift(num3, num7);
						i -= num7;
						mode = 1;
						break;
					case 1:
				...
				case 5:
				{
					...
					while (true)
					{
						...
						int num9 = hufts[(tb[0] + (num3 & inflate_mask[num7])) * 3 + 2];
						if (num9 < 16)
						{
							num3 = SupportClass.URShift(num3, num7);
							i -= num7;
						...
						else
						{
							...
							num3 = SupportClass.URShift(num3, num7);
							i -= num7;
							num11 += (num3 & inflate_mask[num10]);
							num3 = SupportClass.URShift(num3, num10);
							i -= num10;
							num10 = index;
							num7 = table;
							if (num10 + num11 > 258 + (num7 & 0x1F) + ((num7 >> 5) & 0x1F) || (num9 == 16 && num10 < 1))
							{
								blens = null;
								mode = 9;
